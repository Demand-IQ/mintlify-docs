...
Branding controls what homeowners see when they open their presentation — colors, logo, and the call-to-action on the landing page. `palette` and `cta` are required:
