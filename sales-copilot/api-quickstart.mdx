...
<Tip>
Already have your deck as a PowerPoint file? `POST /api/decks/import?source=pptx` creates the deck and its slides from a `.pptx` file in one call, using each slide's speaker notes as its narration script. It replaces steps 2 and 3 — see [Import a PowerPoint presentation](/sales-copilot/guides/deck-types#import-a-powerpoint-presentation).
</Tip>
