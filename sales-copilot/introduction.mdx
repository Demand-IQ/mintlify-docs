...
- **Journey-backed product slides** — bind a product slide to a Demand IQ journey profile (like `roofing_v1`) so product names, prices, images, and highlights are populated from the live journey instead of being edited manually
