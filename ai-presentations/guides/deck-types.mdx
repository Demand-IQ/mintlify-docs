...
- **Instantiate** — `POST /api/templates/{deckId}/use` deep-copies the template into your organization. The new deck is fully independent — edits to the source template do not propagate.
...
Choose **Content Source** in the product slide editor. Narration, CTA copy, and supporting imagery remain editable with either source.

<Tabs>
<Tab title="Custom">
Edit product cards manually, including names, prices, images, and highlights. Use the [product card pricing controls](#product-card-pricing) for ranges and payment options.
</Tab>
<Tab title="Journeys">
