...
PowerPoint files are limited to 25 MB and 50 slides, with a 30 MB cap on the whole request body. Imports are all-or-nothing: if anything fails, no deck is created and the error response tells you why.
